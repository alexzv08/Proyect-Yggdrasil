...
async function cargarUsuarios(){
    const res = await fetch(`http://localhost:80/api/usuarios`,{
    method:"POST",
    headers:{
...
function añadirChat(){
    document.getElementById("addFriend").addEventListener("submit", async (e)=>{
        ...
        const res = await fetch(`http://localhost:80/api/usuarioExistente`,{
            method:"POST",
            headers:{
                "Content-Type":"application/json"
            },
...
async function recuperarSala(user1, user2){
    ...
    const res = await fetch(`http://localhost:80/api/idSalaChat`,{
        method:"POST",
        headers:{
            "Content-Type":"application/json"
        },
...
async function ultimoIdSalaPosible(user1,user2){
    console.log(user1,user2)
    const res = await fetch(`http://localhost:80/api/ultimoIdChat`,{
            method:"POST",
            headers:{
                "Content-Type":"application/json"
            },

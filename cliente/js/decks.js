...
async function crearMazo(){
    if(nombreMazo.value !=''){
        const res = await fetch(`http://13.37.66.226:3000/api/crearMazo`,{
            method:"POST",
            headers:{
...
async function eliminarmazo(){
    ...
    const res = await fetch(`http://13.37.66.226:3000/api/eliminarmazo`,{
        method:"POST",
        headers:{
            "Content-Type":"application/json"
        },
...
const res = await fetch(`http://13.37.66.226:3000/api/recuperarMazosUsuario`,{
        method:"POST",
        headers:{
            "Content-Type":"application/json"
        },

...
async function crearMazo(){
    if(nombreMazo.value !=''){
        const res = await fetch(`http://localhost:80/api/crearMazo`,{
            method:"POST",
            headers:{
...
async function eliminarmazo(){
    ...
    const res = await fetch(`http://localhost:80/api/eliminarmazo`,{
        method:"POST",
        headers:{
            "Content-Type":"application/json"
        },
...
const res = await fetch(`http://localhost:80/api/recuperarMazosUsuario`,{
        method:"POST",
        headers:{
            "Content-Type":"application/json"
        },

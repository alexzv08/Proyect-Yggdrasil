...
async function crearMazo(){
    if(nombreMazo.value !=''){
        const res = await fetch(`http://alexfullstack.net/api/crearMazo`,{
            method:"POST",
            headers:{
...
async function eliminarmazo(){
    ...
    const res = await fetch(`http://alexfullstack.net/api/eliminarmazo`,{
        method:"POST",
        headers:{
            "Content-Type":"application/json"
        },
...
const res = await fetch(`http://alexfullstack.net/api/recuperarMazosUsuario`,{
        method:"POST",
        headers:{
            "Content-Type":"application/json"
        },
